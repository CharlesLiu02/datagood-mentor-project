...
class LinRegWindow(object):
    def __init__(self, master, title, size):
        ...
        self.blurb_var.set("Linear regression is a linear approach to modeling the relationship between dependent and "
                           "independent variables. Shown below is a data set of insurance charges for different "
...
# add options for qualitative data
# add display data that matters
